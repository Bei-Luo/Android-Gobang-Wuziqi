...
public class online_game_ui extends checkerboardUI implements View.OnTouchListener {
    ...
    //回调
    protected self_CallBack callback;
    //玩家执子颜色
    private int RivalChessColor;

    public online_game_ui(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        //注册触摸监听
    ...
    private void shezhiqizi(float downX, float downY) {
        ...
        //判断是否为和棋
        //回调
        callback.self_chess(new Piece(x,y));
    }
     ...
     * @param callback
     */
    public void setCallback(self_CallBack callback) {
